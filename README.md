...
We provide a scripted [extrator](https://github.com/h2tc-roboticsx/H2TC/blob/main/src/extract.py) to unzip the packed raw data and also to organize all raw files in a suitable data hierarchy, as mentioned before. Run the following command below to extract  the raw data to your target path `target_path`: 
```
...
<div align="center">
<img src="https://raw.githubusercontent.com/h2tc-roboticsx/h2tc-roboticsx.github.io/main/assets/images/instruction.png" width=400>
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/h2tc-roboticsx/h2tc-roboticsx.github.io/main/assets/images/annotation_tool.png" alt="interface"  width=600>
</div>
