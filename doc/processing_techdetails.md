...
### Hands Coordinate Frame 

#### Left Hand Frame


**Left hand uses a right-handed coordinate frame** as shown in below. 
Each joint has its own XYZ frame. The X-axis is along the bone, the Y-axis is perpendicular to the palm, and the Z-axis is perpendicular to the XY plane. The enlarged frame at the bottom is for clarification only and not a joint frame.
