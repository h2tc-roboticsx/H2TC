...
This introduce details on how we process [H<sup>2</sup>TC](https://h2tc-roboticsx.github.io/). For a detailed explanation of the data hierarchy and contents in the dataset, please see  [data file explanation](https://github.com/h2tc-roboticsx/H2TC/tree/main/doc/data_file_explanation.md). 
